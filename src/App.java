...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        do{
            ...
            else if(pilihan==4) //transfer uang
            {
                String NoRek;
                long transfer= 0;
                System.out.print("Nomor rekening yang akan ditransfer \t: \t");
                NoRek= input.next();
                ...
                {
                    if(nasabah3.getNoRek().equals(NoRek))
                    {
                        Nasabah transnsb = nasabah3;
                        transnsb.setSaldo(transnsb.getSaldo() + transfer );
                        nasabah.set(i, transnsb);

                        System.out.println("Transfer telah berhasil");
                        logMutasi.add("Uang transfer " + transfer + " ke Rekening " + transnsb.getNoRek() + " " + transnsb.getNamansb());
                    }
                    i++;
                }
            }
    ...
    public static ArrayList<Nasabah> init(ArrayList<Nasabah> nasabah){
        Nasabah nsb1 =  new Nasabah("0214578","Carissa",500000);
        nasabah.add(nsb1);
        Nasabah nsb2 =  new Nasabah("0214571","Baron",500000);
        nasabah.add(nsb2);
        Nasabah nsb3 =  new Nasabah("0214572","Nicole",500000);
        nasabah.add(nsb3);
        nasabah.add( new Nasabah("0214573","Zack",500000));
        return nasabah;
    }
